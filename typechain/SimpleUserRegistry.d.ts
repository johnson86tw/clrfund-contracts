...
interface SimpleUserRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export type UserAddedEvent = TypedEvent<[string] & { _user: string }>;

export type UserRemovedEvent = TypedEvent<[string] & { _user: string }>;

export class SimpleUserRegistry extends BaseContract {
  ...
  callStatic: {
    addUser(_user: string, overrides?: CallOverrides): Promise<void>;

    isVerifiedUser(_user: string, overrides?: CallOverrides): Promise<boolean>;

    owner(overrides?: CallOverrides): Promise<string>;

    removeUser(_user: string, overrides?: CallOverrides): Promise<void>;
